...
var I18N = {
  de: {
    ...
    "limitsWarn": "Diese Einstellungen werden nicht an den Cloudwatcher übertragen und wirken sich nur auf die Diagramme aus.",
    "save": "Speichern",
    ...
    "info.status": "Safe ist die Gesamtentscheidung der Solo: grün heißt sicher, alle eingestellten Grenzen sind eingehalten; rot heißt unsicher, mindestens eine Grenze ist verletzt. Switch ist der Schaltausgang der Solo, etwa für ein Dach: grün heißt an, rot heißt aus.",
  ...
  en: {
    ...
    "limitsWarn": "These settings are not sent to the CloudWatcher and only affect the diagrams.",
    "save": "Save",
    "pageCharts": "CloudWatcher",
    ...
    "info.status": "Safe is the Solo's overall decision: green means safe, every configured limit is met; red means unsafe, at least one limit is exceeded. Switch is the Solo's switch output, for example for a roof: green means on, red means off.",
